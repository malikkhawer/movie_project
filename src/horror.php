					...
					<h3 class="agile_w3_title hor-t">Horror<span>Movies</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
										<div class="col-md-2 w3l-movie-gride-agile requested-movies">
											...
											<div class="col-md-2 w3l-movie-gride-agile requested-movies">
															<a href="single.php" class="hvr-sweep-to-bottom"><img src="images/hr6.jpg" title="Movies Pro" class="img-responsive" alt=" ">
																<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
															</a>
																<div class="mid-1 agileits_w3layouts_mid_1_home">
																	<div class="w3l-movie-text">
																		<h6><a href="single.php">Underworld</a></h6>							
																	</div>
																	<div class="mid-2 agile_mid_2_home">
																		<p>2016</p>
																		<div class="block-stars">
											...
											<div class="col-md-2 w3l-movie-gride-agile requested-movies">
												<a href="single.php" class="hvr-sweep-to-bottom"><img src="images/hr7.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
											...
											<div class="col-md-2 w3l-movie-gride-agile requested-movies">
												<a href="single.php" class="hvr-sweep-to-bottom"><img src="images/hr8.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
														<h6><a href="single.php">Viral</a></h6>							
													</div>
													<div class="mid-2 agile_mid_2_home">
														<p>2016</p>
														<div class="block-stars">
											...
											<div class="col-md-2 w3l-movie-gride-agile requested-movies">
												<a href="single.php" class="hvr-sweep-to-bottom"><img src="images/hr9.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
														<h6><a href="single.php">Ouija </a></h6>							
													</div>
													<div class="mid-2 agile_mid_2_home">
														<p>2016</p>
														<div class="block-stars">
											...
											<div class="col-md-2 w3l-movie-gride-agile requested-movies">
												<a href="single.php" class="hvr-sweep-to-bottom"><img src="images/hr10.jpg" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
